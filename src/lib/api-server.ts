...
const DEFAULT_WALLS_PER_PLAYER = 10;
...
async function ensureSchema() {
  ...
  schemaPromise ??= (async () => {
    ...
    await sql`INSERT INTO game_settings (key,value) VALUES ('walls_per_player',${DEFAULT_WALLS_PER_PLAYER}) ON CONFLICT (key) DO NOTHING`;
